[19:29, 23/07/2024] Cristina: use anchor_lang::prelude::*;
use anchor_spl::{
...
use crate::Offer;
[19:29, 23/07/2024] Cristina: #[derive(Accounts)]
...
[19:30, 23/07/2024] Cristina: #[account(
 init_if_needed,
 payer = taker,
 associated_token::mint = token_mint_b,
...
[19:30, 23/07/2024] Cristina: pub fn send_wanted_tokens_to_maker(ctx: &Context<TakeOffer>) -> Result<()> {
...
[19:30, 23/07/2024] Cristina: pub fn withdraw_and_close_vault(ctx: Context<TakeOffer>) -> Result<()> {
...
continued on
[19:31, 23/07/2024] Cristina: transfer_checked(
 cpi_context,
